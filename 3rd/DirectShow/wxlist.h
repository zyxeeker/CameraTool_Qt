...
public:
    ...
    public:
        ...
        *
        ...
        void SetPrev(__in_opt CNode

        *p) { m_pPrev = p; };


        /* Set the next node after this one */
        void SetNext(__in_opt CNode
...
protected:
    ...
    */
    __out void *GetNextI(__inout POSITION &
...
public:
    ...
    /* Add the list *pList to *this after position p in *this
       ...
       Existing POSITIONs in *this are undisturbed, including p.
    */
    BOOL AddAfter(__in_opt POSITION p, __in CBaseList
...
public:
    ...
    /* Add the list *pList to *this before position p in *this
       ...
       Existing POSITIONs in *this are undisturbed, including p.
    */
    BOOL AddBefore(__in_opt POSITION p, __in CBaseList
    ...
    */
    BOOL MoveToHead(__in_opt POSITION pos, __in CBaseList
...
public:
    ...
    *
    GetNext(__inout
    POSITION &rp
    ) const { return (OBJECT *) GetNextI(rp); }

    __out_opt OBJECT
    *
    Get(__in_opt
    POSITION p
    ) const { return (OBJECT *) GetI(p); }
    __out OBJECT
    *
    GetValid(__in
    POSITION p
    ) const { return (OBJECT *) GetValidI(p); }
    __out_opt OBJECT
    *

    GetHead() const { return Get(GetHeadPosition()); }

    __out_opt OBJECT
    *

    RemoveHead() { return (OBJECT *) RemoveHeadI(); }

    __out_opt OBJECT
    *

    RemoveTail() { return (OBJECT *) RemoveTailI(); }
