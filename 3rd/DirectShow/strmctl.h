...
private:
    ...
    //
    enum StreamControlState CheckSampleTimes(__in const REFERENCE_TIME

    * pSampleStart,
    __in const REFERENCE_TIME
    * pSampleStop );
...
public:
    ...
    // below.
    //
    CBaseStreamControl(__inout_opt HRESULT
    ...
    *
    ...
    STDMETHODIMP GetInfo(__out AM_STREAM_INFO
