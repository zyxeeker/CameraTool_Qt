...
public:
    ...
    *phr,
    ...
    STDMETHODIMP EnumMediaTypes(__deref_out IEnumMediaTypes
    ...
    *
    ...
    PeekAllocator() const { return m_pAllocator; }
...
public:
    ...
    **ppEnum );
    ...
    __out_opt IMemInputPin
    *

    ConnectedIMemInputPin() { return m_pInputPin; }
...
class AM_NOVTABLE CTransInPlaceFilter
...
CTransInPlaceFilter(__in_opt
LPCTSTR,
__inout_opt LPUNKNOWN, REFCLSID
clsid,
__inout HRESULT
*,
...
HRESULT GetMediaType(int iPosition, __inout CMediaType
...
__out CTransInPlaceInputPin
*

InputPin() const {
    return (CTransInPlaceInputPin *) m_pInput;
};
__out CTransInPlaceOutputPin
*
