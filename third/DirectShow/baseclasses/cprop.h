...
: public IPropertyPage, public CUnknown
{
protected:
...
CBasePropertyPage(__in_opt
LPCTSTR pName,      // Debug only name
__inout_opt
...
virtual INT_PTR OnReceiveMessage(HWND
hwnd,
UINT uMsg, WPARAM
wParam,
LPARAM lParam
...
STDMETHODIMP SetPageSite(__in_opt
LPPROPERTYPAGESITE pPageSite
);
STDMETHODIMP Activate(HWND
hwndParent,
LPCRECT prect, BOOL
fModal);
