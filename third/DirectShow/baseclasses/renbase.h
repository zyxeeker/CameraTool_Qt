...
public:
    ...
    CRendererInputPin(__inout CBaseRenderer
...
protected:
    ...
    EndOfStreamTimer(UINT
    uID,      // Timer identifier
    UINT uMsg,     // Not currently used
    DWORD_PTR
    dwUser,  // User information
    DWORD_PTR dw1,     // Windows reserved
    DWORD_PTR
    dw2);    // Is also reserved
...
public:
    ...
    *ptrEnd);
    ...
    STDMETHODIMP JoinFilterGraph(__inout_opt IFilterGraph
