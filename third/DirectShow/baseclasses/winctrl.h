...
public:
    ...
    CBaseControlWindow(__inout CBaseFilter

    *pFilter,   // Owning media filter
    __in CCritSec
    *pInterfaceLock,  // Locking object
    __in_opt LPCTSTR
    pName,         // Object description
    __inout_opt LPUNKNOWN
    pUnk,     // Normal COM ownership
    __inout HRESULT
    *phr);          // OLE return code
    ...
    STDMETHODIMP get_Caption(__out BSTR
    ...
    *pstrCaption);
    ...
    STDMETHODIMP get_Owner(__out OAHWND

    *Owner);

    STDMETHODIMP put_MessageDrain(OAHWND Drain);

    STDMETHODIMP get_MessageDrain(__out OAHWND
...
public:
    ...
    virtual HRESULT GetStaticImage(__inout long *pBufferSize, __out_bcount_part(*pBufferSize,
    ...
    *
    ...
    HRESULT GetImageSize(__in VIDEOINFOHEADER
    ...
    *pBufferSize,
    ...
    void SetControlVideoPin(__inout CBasePin
    ...
    *pPin) {
    ...
    virtual HRESULT CheckSourceRect(__in RECT

    *pSourceRect);

    virtual HRESULT CheckTargetRect(__in RECT

    *pTargetRect);

public:

    CBaseControlVideo(__inout CBaseFilter

    *pFilter,    // Owning media filter
    __in CCritSec
    *pInterfaceLock,   // Serialise interface
    __in_opt LPCTSTR
    pName,          // Object description
    __inout_opt LPUNKNOWN
    pUnk,      // Normal COM ownership
    ...
    *phr);           // OLE return code
    ...
    STDMETHODIMP get_AvgTimePerFrame(__out REFTIME
    ...
    *pAvgTimePerFrame);
    ...
    STDMETHODIMP
    GetVideoPaletteEntries(long StartIndex, long Entries, __out long *pRetrieved, __out_ecount_part(Entries,
    ...
    *pRetrieved)
    ...
    STDMETHODIMP GetCurrentImage(__inout long *pBufferSize, __out_bcount_part(*pBufferSize,
