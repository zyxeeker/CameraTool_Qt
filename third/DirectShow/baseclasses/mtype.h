...
public:
    ...
    CMediaType(const AM_MEDIA_TYPE &, __out_opt HRESULT

    *
    phr = NULL
    );

    CMediaType(const CMediaType &, __out_opt HRESULT
...
void WINAPI
DeleteMediaType(__inout_opt
AM_MEDIA_TYPE *pmt
);
AM_MEDIA_TYPE *WINAPI
