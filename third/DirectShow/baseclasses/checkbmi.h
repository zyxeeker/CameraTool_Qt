...
__inline BOOL ValidateBitmapInfoHeader(
...
if (!
MultiplyCheckOverflow(dwBpp, (DWORD)
pbmi->biWidth, &dwWidthInBits)) {
return
FALSE;
}
...
if (!
MultiplyCheckOverflow(dwWidthInBytes, dwHeight, &dwSizeImage
)) {
return
FALSE;
}
