...
public:
    ...
    * phr,
    ...
    STDMETHODIMP QueryId(__deref_out LPWSTR
...
class AM_NOVTABLE CTransformFilter
...
STDMETHODIMP FindPin(LPCWSTR Id, __deref_out IPin
...
HRESULT InitializeOutputSample(IMediaSample *pSample, __deref_out IMediaSample
