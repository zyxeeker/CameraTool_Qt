...
public:
    ...
    CDrawImage(__inout CBaseWindow
    ...
    *pBaseWindow);
    ...
    void SetTargetRect(__in RECT

    *pTargetRect);

    void SetSourceRect(__in RECT

    *pSourceRect);

    void GetTargetRect(__out RECT

    *pTargetRect);

    void GetSourceRect(__out RECT
    ...
    *pSourceRect);
    ...
    void NotifyMediaType(__in CMediaType
...
public:
    ...
    CImageSample(__inout CBaseAllocator
...
protected:
    ...
    STDMETHODIMP CheckSizes(__in ALLOCATOR_PROPERTIES
...
public:
    ...
    CImageAllocator(__inout CBaseFilter
...
public:
    ...
    CImagePalette(__inout CBaseFilter
    ...
    *pDrawImage);
    ...
    HRESULT CopyPalette(const CMediaType *pSrc, __out CMediaType
...
public:
    ...
    HRESULT UpdateFormat(__inout VIDEOINFO

    *pVideoInfo);

    const DWORD *GetBitMasks(const VIDEOINFO *pVideoInfo);

    BOOL GetColourMask(__out DWORD
...
STDAPI ConvertVideoInfoToVideoInfo2(__inout AM_MEDIA_TYPE
