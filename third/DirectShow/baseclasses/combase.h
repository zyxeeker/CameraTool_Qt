...
typedef REGPINTYPES
        AMOVIESETUP_MEDIATYPE, *PAMOVIESETUP_MEDIATYPE, *FAR
LPAMOVIESETUP_MEDIATYPE;

typedef REGFILTERPINS
        AMOVIESETUP_PIN, *PAMOVIESETUP_PIN, *FAR
LPAMOVIESETUP_PIN;
...
typedef struct _AMOVIESETUP_FILTER {
    ...
    const AMOVIESETUP_PIN *lpPin;
        ...
        AMOVIESETUP_FILTER, *PAMOVIESETUP_FILTER, *FAR
...
CUnknown(__in_opt
LPCTSTR Name, __in_opt
LPUNKNOWN pUnk, __inout_opt
HRESULT *phr
);
#ifdef UNICODE
...
public:
    ...
    CUnknown *CreateInstance(__inout_opt LPUNKNOWN pUnk, __inout_opt HRESULT
