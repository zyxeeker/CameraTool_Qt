...
BOOL CALLBACK FindDeviceCallback(__in_opt GUID * lpGUID, __in LPSTR
szName, __in LPSTR szDevice, __in LPVOID
lParam)
{
...
BOOL CALLBACK FindDeviceCallbackEx(__in_opt GUID * lpGUID, __in LPSTR
szName, __in LPSTR szDevice, __in LPVOID
lParam,
HMONITOR hMonitor
)
 ...
 */
IDirectDraw *
DirectDrawCreateFromDevice(__in_opt LPSTR szDevice, PDRAWCREATE DirectDrawCreateP, PDRAWENUM DirectDrawEnumerateP) {
